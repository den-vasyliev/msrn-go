...
func main() {
	...
	go func() {
		...
		for d := range msgs {
			...
			_, err := client.Get("https://ps.pndsn.com/publish/pub-c-356be33a-08e5-4678-a737-f3f0527a0a64/sub-c-5e07b1f2-9ba2-11e8-9a92-b209910313bb/0/channel-mapbox/myCallback/%7B%22text%22%3A%22hey%22%7D?store=0&uuid=db9c5e39-7c95-40f5-8d71-125765b6f561")
			if err != nil {
				fmt.Println(err)
			}
			/**
